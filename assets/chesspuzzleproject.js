...
function onDrop(source, target) {
	...
	if (piece === 'p' &&
		...
		promotion_dialog.dialog({
			...
			of: $('#myBoard'),
			my: 'middle middle',
			at: 'middle middle',   //Maybe add code to position near the pawn being promoted?
		});
